...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='Buckets in object storage';
...
(
  ...
  AUTO_INCREMENT = 112
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Contains information for different categories.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  ROW_FORMAT = DYNAMIC COMMENT ='Contains logfiles that are both archives and detected to be corrupted.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `corrupted_archive`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `corrupted_archive`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 112
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Host names';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 32
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Contains additional attributes for logfiles. The attributes do not apply to each logfile and therefore are not columns in Logfile table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `metadata_value`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `metadata_value`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci
  ROW_FORMAT = DYNAMIC COMMENT ='Glacier restoration jobs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 113
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='Contains information for different applications.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `source_system`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `source_system`
    ENABLE KEYS */;
UNLOCK TABLES;
