...
/**
 * Contains additional attributes for logfiles. The attributes do not apply 
 * to each logfile and therefore are not columns in Logfile table
 */
@Generated(
    value = {
        "http://www.jooq.org",
...
public class MetadataValue extends TableImpl<MetadataValueRecord> {
    ...
    private static final long serialVersionUID = -767644173;
    ...
    private MetadataValue(Name alias, Table<MetadataValueRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Contains additional attributes for logfiles. The attributes do not apply to each logfile and therefore are not columns in Logfile table"));
    }
