...
public final class BinaryOfString implements Binary {
    ...
    public BinaryOfString(final String value, final boolean acceptNullValue) {
        this.value = value;
    ...
    public byte[] bytes() {
        ...
        if (value == null && acceptNullValue) { // empty bytes represents a null value in hbase
            ...
            throw new HbsRuntimeException(
                    ...
                    new IllegalStateException("String value was null")
            );
        }
        else {
    ...
    public boolean equals(final Object o) {
        ...
        final BinaryOfString that = (BinaryOfString) o;
