...
public final class BinaryOfUInteger implements Binary {
    ...
    public BinaryOfUInteger(final UInteger value, final boolean acceptNullValue) {
        this.value = value;
    ...
    public byte[] bytes() {
        ...
        if (value == null && acceptNullValue) { // empty bytes represents a null value in hbase
            ...
            throw new HbsRuntimeException(
                    ...
                    new IllegalStateException("UInteger value was null")
            );
        }
        else {
    ...
    public boolean equals(final Object o) {
        ...
        final BinaryOfUInteger that = (BinaryOfUInteger) o;
