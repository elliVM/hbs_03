...
public final class BinaryOfUShort implements Binary {
    ...
    public BinaryOfUShort(final UShort value, final boolean acceptNullValue) {
        this.value = value;
    ...
    public byte[] bytes() {
        ...
        if (value == null && acceptNullValue) { // empty bytes represents a null value in hbase
            ...
            throw new HbsRuntimeException(
                    ...
                    new IllegalStateException("UShort value was null")
            );
        }
        else {
    ...
    public boolean equals(final Object o) {
        ...
        final BinaryOfUShort that = (BinaryOfUShort) o;
